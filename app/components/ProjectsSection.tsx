...
function ProjectsSection() {
  return (
    <div
      id="projects"
      className="p-8 pt-0 space-y-3 w-full border-3 border-green-500"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="rounded-lg border border-gray-300 dark:bg-gray-100/10 shadow-md p-4">
          ...
          <h3 className="text-xl font-semibold text-red-600">
            Real Estate Platform (FYP)
          </h3>
          <p className=" text-sm mt-1">
            A full-featured property listing platform built with Next.js,
            Tailwind, and Supabase. Includes advance filtering, authentication,
            map integration and responsive UI.
          </p>
        ...
        <div className="rounded-lg border border-gray-300 dark:bg-gray-100/10  shadow-md p-4">
          ...
          <p className=" text-sm mt-1">
            A sleek portfolio site built using React and Tailwind CSS, featuring
            dark mode, animated sections, and a contact form.
          </p>
          <div className="flex gap-3 mt-3">
            <a
        ...
        <div className="dark:bg-gray-100/10 rounded-lg border border-gray-300 bg-white shadow-md p-4">
          ...
          <h3 className="text-xl font-semibold text-purple-600">
            CyberLock Simulator: Teaching the Impact of Ransomware
          </h3>
          <p className="text-sm mt-1">
            <LucideMessageCircleWarning className="h-5 w-5 inline" />
            This Project was build purely for educational purpose and tested in
            a controlled enviroment, The Developer will not be held responsible
            for any misuse of the video or code.
          </p>
          <div className="flex gap-3 mt-3">
            <a
